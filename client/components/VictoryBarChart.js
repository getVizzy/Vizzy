...
import { VictoryBar, VictoryChart, VictoryAxis, VictoryStack, VictoryTheme, VictoryTooltip, VictoryLabel } from 'victory';
...
//ENSURE JSON DATA VALUES ARE NUMBERS NOT STRINGS
  ...
  let data = [{"Month":"January","Apples":50,"Revenue":1230},{"Month":"February","Apples":75,"Revenue":1500},{"Month": "March","Apples":90,"Revenue":1900},{"Month":"April","Apples":67,"Revenue":1300},{"Month":"May","Apples":123,"Revenue":1200},{"Month":"June","Apples":56,"Revenue":1345},{"Month":"July","Apples":87,"Revenue":1875},{"Month":"August","Apples":143,"Revenue":1300},{"Month":"September","Apples":59,"Revenue":1330},{"Month":"October","Apples":68,"Revenue":1450},{"Month":"November","Apples":89,"Revenue":1890},{"Month":"December","Apples":100,"Revenue":1100}]
...
class VictoryBarChart extends Component {
  ...
  addComma(stringNum) {
    if(stringNum.length > 3) {
      return `${stringNum.slice(0, stringNum.length-3)},${stringNum.slice(stringNum.length-3)}`
    }
  }
      ...
      return (
        <div id="container">
          <div id="chart">
            <VictoryChart
              ...
              <VictoryLabel
                ...
                style={{fontSize: 16, textAnchor: "start", verticalAnchor: "end", fill: "#000000", fontFamily: "inherit", fontWeight: "bold"}}
                x={100} y={24} />
              ...
              <VictoryBar
                labelComponent={<VictoryTooltip flyoutStyle={{fill: "white", stroke: "lightgrey" }} cornerRadius={+this.state.tooltip}/>}
                  ...
                  eventHandlers: {
                    onMouseOver: () => {
                      return [
                        {
                          target: "data",
                          mutation: () => ({style: {fill: this.state.highlight}})
                        }, {
                          target: "labels",
          ...
          <div id="controls">
            ...
            <select onChange={(e) => this.changeStyle(e, "column")} >
              {keys.map((key, i) => {
                if(key !== "label" && key !== keys[0]) {
                  return <option key={i} name="column" value={key}>{`${key[0].toUpperCase()}${key.slice(1)}`}</option>
              }})}
            </select>
            ...
            <p>Graph Title:</p>
            <input value={this.state.title} onChange={(e) => this.changeStyle(e, "title")} />
